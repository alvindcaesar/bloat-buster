...
function bbuster_options_page()
{
  ...
  <div class="wrap">
    ...
    <form method="post" action="options.php">
      ...
      <p>
        <input name="bbuster_disable_emoji" id="bbuster_disable_emoji" type="checkbox" value="1" <?php checked('1', $bbuster_options[0]); ?> />
        <label for="bbuster_disable_emoji" class="description">Remove Emoji Scripts</label>
      </p>

      <p>
        <input name="bbuster_disable_fse_global_styles" id="bbuster_disable_fse_global_styles" type="checkbox" value="1" <?php checked('1', $bbuster_options[1]); ?> />
